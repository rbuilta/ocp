...
**As of this writing the 'destroy' cluster cababilities are not working for Azure Gov from ACM - you will need to destroy the cluster from ACM as well as go into Azure Gov UI and destroy the cluster**

*BUGZILLA's:*
- https://bugzilla.redhat.com/show_bug.cgi?id=1900728
- https://bugzilla.redhat.com/show_bug.cgi?id=1899719
****
